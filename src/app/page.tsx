    ...
    >
      ...
      <section
        className="relative flex flex-col items-center justify-center
          text-center gap-6 py-24 px-6 sm:py-32 sm:px-8 md:py-48
          md:px-32 overflow-hidden"
      >
        {/* <Image
          src="/hero-bg.jpg"
          alt="Hero Background"
        ...
        >
          <Typography className="text-3xl sm:text-4xl md:text-6xl font-extrabold text-white">
            Unlock Your Memories with{' '}
            <span className="text-indigo-500">
              AI-Powered Insights
            </span>
          </Typography>
          <Typography className="mt-4 text-base sm:text-lg md:text-2xl text-gray-200">
            Transcribe and transform your voice memos into
            organized, insightful, and searchable memories.
            Rediscover your story in a whole new way.
          </Typography>
          <Link href="#get-started">
            <Button
              size="lg"
              className="mt-8 bg-indigo-600 hover:bg-indigo-700 px-6 sm:px-8 md:px-10
                text-sm sm:text-base text-white mx-auto"
            >
              Get Started
            </Button>
          </Link>
      ...
      <section
        className="relative flex flex-col items-center justify-center
          text-center gap-6 py-16 sm:py-24 px-6 sm:px-8 md:px-32
      ...
      >
        ...
        <div className="relative z-10 max-w-2xl mx-auto">
          ...
          <Typography className="mt-4 text-base sm:text-lg md:text-2xl text-gray-200">
            Getting started with Legacy AI is simple. Upload
            your voice memos, and let our AI handle the
            rest—transcribing, analyzing, and organizing
            them into a dynamic, interactive feed.
          </Typography>
          <Link href="#get-started">
            <Button
              size="lg"
      ...
      <section
        className="py-16 sm:py-24 px-6 sm:px-8 md:px-32 bg-indigo-600
          text-center"
      >
        <Typography className="text-3xl sm:text-4xl md:text-5xl font-semibold text-white">
        ...
        <Typography
          className="mt-4 text-base sm:text-lg md:text-2xl text-white max-w-2xl
            mx-auto"
        >
          Join a growing community of users turning voice
          notes into impactful, lasting memories. Don’t let
          your stories fade—start preserving them today.
        </Typography>
        <Link href="/signup">
          <Button
            size="lg"
            variant="default"
            className="mt-8 bg-white text-indigo-600 hover:bg-gray-200 px-6 sm:px-8
              md:px-10 text-sm sm:text-base mx-auto"
          >
            Get Started
          </Button>
        </Link>
      ...
      {/* Footer Section */}
      <footer
        className="flex flex-col items-center text-center py-12 px-6 sm:px-8
          bg-gray-800"
      >
        <Typography className="text-lg sm:text-xl md:text-2xl font-semibold text-white">
          © {new Date().getFullYear()} Legacy AI. All
          rights reserved.
        </Typography>
